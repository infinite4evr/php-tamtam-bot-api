 ...
 * Visit < https://github.com/Eleirbag89/TelegramBotPHP/blob/master/TelegramErrorLogger.php > 
 */
class TamTamErrorLogger
{
    private static $self;
    /// Log request and response parameters from/to TamTam API
    /**
     * Prints the list of parameters from/to TamTam's API endpoint
     * \param $result the TamTam's response as array
    ...
    /**
     * Write a string in the log file TamTamErrorLogger.txt adding the current server time
